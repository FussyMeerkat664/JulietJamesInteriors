...
<?php include('sidebar.php'); ?>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between mt-3 flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h1 class="display-6 fs-1">Manage Product</h1>
          ...
          <?php   
            ...
            <div class="table-responsive">
              <div class="col-2 ms-auto">
                <a href="addproduct.php" class="mb-3 btn btn-outline-success" style="width: 150px;">Add Product</a>
              </div>
              <table id="category_list" class="table table-bordered text-center mt-3">
                <thead>
                  <tr>
                    ...
                    <th scope="col" class="text-center">ItemCatagory</th>
                  ...
                  if($result)
                  {
                    ...
                    { 
                      ?>
                        ...
                        <td><img src="<?= $row['ItemImage']?>" width=100   alt=""> </td>
                        <td> <?= $row['ItemPrice']?></td>
                        <td> <?= $row['ItemStock']?></td>
